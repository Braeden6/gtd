...
async def get_image_by_id(
    ...
    return await image_service.get_by_id(id=image_id, user_id=current_user.id)
...
async def get_image_file_by_id(
    ...
    image = await image_service.get_by_id(id=image_id, user_id=current_user.id)
...
async def get_all_images(
    ...
    return await image_service.get_all(user_id=current_user.id)
