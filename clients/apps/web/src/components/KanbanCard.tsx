        ...
        <div className="p-3 flex flex-col gap-1">
          ...
          {item.priority && (
            <div>
              <Badge 
                variant="outline" 
                className={`text-xs ${priorityColors[item.priority as keyof typeof priorityColors]} text-inherit`}
              >
                Priority: {priorityNames[item.priority as keyof typeof priorityNames]}
              </Badge>
            </div>
          )}
        </div>
